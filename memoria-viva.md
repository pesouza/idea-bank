...
\n\n## Código Widget Chat (aeria-cs.com.br)\n\n```html\n<script>\n  window.aeriaChatSettings = {\n    apiUrl: "https://webhook.aeria-apps.com.br/webhook/chat",\n    themeColor: "#050814",\n    buttonText: "Como posso ajudar?"\n  };\n</script>\n<script src="https://aeria-apps.com.br/static/chat-widget.js" defer></script>\n```
\n- **Padrão de Conteúdo (Blog):** Posts devem ser baseados em problemas operacionais reais de PMEs, conectando-os diretamente às soluções de "Selfware" da Aeria. Evitar conteúdo genérico sobre IA. Foco em aplicação prática e dor do cliente.
\n- **Discrepância de Skills:** A skill `claude-code` instalada no ambiente é para delegação de codificação, não para geração de imagens. Existe uma outra skill com o mesmo nome, focada em imagens, que precisa ser instalada para resolver o bloqueio de geração de conteúdo visual.
\n- **Skills de Imagem Candidatas:** Para resolver o bloqueio de geração de imagens, duas skills foram identificadas: "Claude Code for Image Creation" (link: share.google/DjFlO0jHrLPMC9crh) e "Skill Image da OpenClaw Brasil" (link: share.google/JSpkLzpcaE283Sv49). Uma delas precisa ser instalada.
